# Comparing `tmp/BHBot-2.0.tar.gz` & `tmp/bhbot-2.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "BHBot-2.0.tar", last modified: Fri Mar 29 03:16:53 2024, max compression
+gzip compressed data, was "bhbot-2.1.tar", last modified: Thu Apr 18 20:34:05 2024, max compression
```

## Comparing `BHBot-2.0.tar` & `bhbot-2.1.tar`

### file list

```diff
@@ -1,22 +1,25 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-03-29 03:16:53.682819 BHBot-2.0/
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-03-29 03:16:53.682819 BHBot-2.0/BHBot.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     4838 2024-03-29 03:16:53.000000 BHBot-2.0/BHBot.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      276 2024-03-29 03:16:53.000000 BHBot-2.0/BHBot.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-03-29 03:16:53.000000 BHBot-2.0/BHBot.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-03-29 03:16:53.000000 BHBot-2.0/BHBot.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)     1211 2024-03-29 03:16:49.000000 BHBot-2.0/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)     4838 2024-03-29 03:16:53.682819 BHBot-2.0/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     4634 2024-03-29 03:16:49.000000 BHBot-2.0/README.md
--rw-r--r--   0 runner    (1001) docker     (127)      761 2024-03-29 03:16:49.000000 BHBot-2.0/abstract_mode.py
--rw-r--r--   0 runner    (1001) docker     (127)    20275 2024-03-29 03:16:49.000000 BHBot-2.0/bot.py
--rw-r--r--   0 runner    (1001) docker     (127)     3882 2024-03-29 03:16:49.000000 BHBot-2.0/characters.py
--rw-r--r--   0 runner    (1001) docker     (127)      252 2024-03-29 03:16:49.000000 BHBot-2.0/client_config.py
--rw-r--r--   0 runner    (1001) docker     (127)    10310 2024-03-29 03:16:49.000000 BHBot-2.0/config.py
--rw-r--r--   0 runner    (1001) docker     (127)     6470 2024-03-29 03:16:49.000000 BHBot-2.0/direct_input.py
--rw-r--r--   0 runner    (1001) docker     (127)      658 2024-03-29 03:16:49.000000 BHBot-2.0/font_loader.py
--rw-r--r--   0 runner    (1001) docker     (127)     4997 2024-03-29 03:16:49.000000 BHBot-2.0/levels.py
--rw-r--r--   0 runner    (1001) docker     (127)     5602 2024-03-29 03:16:49.000000 BHBot-2.0/menu.py
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-03-29 03:16:53.682819 BHBot-2.0/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)      336 2024-03-29 03:16:49.000000 BHBot-2.0/setup.py
--rw-r--r--   0 runner    (1001) docker     (127)    13354 2024-03-29 03:16:49.000000 BHBot-2.0/utils.py
--rw-r--r--   0 runner    (1001) docker     (127)     6517 2024-03-29 03:16:49.000000 BHBot-2.0/windows.py
...
### Comparing `BHBot-2.0/LICENSE` & `bhbot-2.1/LICENSE`
...
### Comparing `BHBot-2.0/abstract_mode.py` & `bhbot-2.1/abstract_mode.py`
...
### Comparing `BHBot-2.0/bot.py` & `bhbot-2.1/bot.py`
...
### Comparing `BHBot-2.0/characters.py` & `bhbot-2.1/characters.py`
...
### Comparing `BHBot-2.0/config.py` & `bhbot-2.1/config.py`
...
### Comparing `BHBot-2.0/direct_input.py` & `bhbot-2.1/direct_input.py`
...
### Comparing `BHBot-2.0/menu.py` & `bhbot-2.1/menu.py`
...
### Comparing `BHBot-2.0/utils.py` & `bhbot-2.1/utils.py`
...
### Comparing `BHBot-2.0/windows.py` & `bhbot-2.1/windows.py`
