# Comparing `tmp/GoogleAdsQueryTool-0.1.4.tar.gz` & `tmp/GoogleAdsQueryTool-0.1.5.tar.gz`
...
## Comparing `GoogleAdsQueryTool-0.1.4.tar` & `GoogleAdsQueryTool-0.1.5.tar`
...
### Comparing `GoogleAdsQueryTool-0.1.4/setup.py` & `GoogleAdsQueryTool-0.1.5/setup.py`
