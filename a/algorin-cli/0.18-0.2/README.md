# Comparing `tmp/algorin_cli-0.18.tar.gz` & `tmp/algorin-cli-0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "algorin_cli-0.18.tar", last modified: Thu Apr 18 01:24:37 2024, max compression
+gzip compressed data, was "algorin-cli-0.2.tar", last modified: Wed Apr 17 21:55:16 2024, max compression
```

## Comparing `algorin_cli-0.18.tar` & `algorin-cli-0.2.tar`

### file list

```diff
@@ -1,22 +1,22 @@
-drwxr-xr-x   0 1064331    (502) staff       (20)        0 2024-04-18 01:24:36.999586 algorin_cli-0.18/
--rw-r--r--   0 1064331    (502) staff       (20)     7652 2024-04-18 01:24:36.993966 algorin_cli-0.18/PKG-INFO
--rw-r--r--   0 1064331    (502) staff       (20)       33 2024-04-17 19:58:47.000000 algorin_cli-0.18/README.md
-drwxr-xr-x   0 1064331    (502) staff       (20)        0 2024-04-18 01:24:36.966909 algorin_cli-0.18/algorin/
--rw-r--r--   0 1064331    (502) staff       (20)      515 2024-04-18 01:24:21.000000 algorin_cli-0.18/algorin/__init__.py
--rw-r--r--   0 1064331    (502) staff       (20)     1284 2024-04-18 01:06:50.000000 algorin_cli-0.18/algorin/chatbot.py
--rw-r--r--   0 1064331    (502) staff       (20)     1021 2024-04-17 22:04:49.000000 algorin_cli-0.18/algorin/file_extractor.py
--rw-r--r--   0 1064331    (502) staff       (20)     2230 2024-04-18 01:20:13.000000 algorin_cli-0.18/algorin/main.py
-drwxr-xr-x   0 1064331    (502) staff       (20)        0 2024-04-18 01:24:36.985815 algorin_cli-0.18/algorin_cli.egg-info/
--rw-r--r--   0 1064331    (502) staff       (20)     7652 2024-04-18 01:24:36.000000 algorin_cli-0.18/algorin_cli.egg-info/PKG-INFO
--rw-r--r--   0 1064331    (502) staff       (20)      399 2024-04-18 01:24:36.000000 algorin_cli-0.18/algorin_cli.egg-info/SOURCES.txt
--rw-r--r--   0 1064331    (502) staff       (20)        1 2024-04-18 01:24:36.000000 algorin_cli-0.18/algorin_cli.egg-info/dependency_links.txt
--rw-r--r--   0 1064331    (502) staff       (20)       55 2024-04-18 01:24:36.000000 algorin_cli-0.18/algorin_cli.egg-info/entry_points.txt
--rw-r--r--   0 1064331    (502) staff       (20)     3831 2024-04-18 01:24:36.000000 algorin_cli-0.18/algorin_cli.egg-info/requires.txt
--rw-r--r--   0 1064331    (502) staff       (20)       14 2024-04-18 01:24:36.000000 algorin_cli-0.18/algorin_cli.egg-info/top_level.txt
--rw-r--r--   0 1064331    (502) staff       (20)       38 2024-04-18 01:24:36.999765 algorin_cli-0.18/setup.cfg
--rw-r--r--   0 1064331    (502) staff       (20)      879 2024-04-18 01:24:27.000000 algorin_cli-0.18/setup.py
-drwxr-xr-x   0 1064331    (502) staff       (20)        0 2024-04-18 01:24:36.983736 algorin_cli-0.18/tests/
--rw-r--r--   0 1064331    (502) staff       (20)      178 2024-04-17 20:21:38.000000 algorin_cli-0.18/tests/__init__.py
--rw-r--r--   0 1064331    (502) staff       (20)      546 2024-04-17 20:22:40.000000 algorin_cli-0.18/tests/test_chatbot.py
--rw-r--r--   0 1064331    (502) staff       (20)      769 2024-04-17 20:22:47.000000 algorin_cli-0.18/tests/test_file_extractor.py
--rw-r--r--   0 1064331    (502) staff       (20)      631 2024-04-17 20:22:52.000000 algorin_cli-0.18/tests/test_main.py
...
### Comparing `algorin_cli-0.18/PKG-INFO` & `algorin-cli-0.2/PKG-INFO`
...
### Comparing `algorin_cli-0.18/algorin/chatbot.py` & `algorin-cli-0.2/algorin-cli/main.py`
...
### Comparing `algorin_cli-0.18/algorin/file_extractor.py` & `algorin-cli-0.2/algorin-cli/file_extractor.py`

 * *Files identical despite different names*

### Comparing `algorin_cli-0.18/algorin_cli.egg-info/PKG-INFO` & `algorin-cli-0.2/algorin_cli.egg-info/PKG-INFO`
...
### Comparing `algorin_cli-0.18/algorin_cli.egg-info/requires.txt` & `algorin-cli-0.2/algorin_cli.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `algorin_cli-0.18/setup.py` & `algorin-cli-0.2/setup.py`
...
### Comparing `algorin_cli-0.18/tests/test_chatbot.py` & `algorin-cli-0.2/tests/test_chatbot.py`

 * *Files identical despite different names*

### Comparing `algorin_cli-0.18/tests/test_file_extractor.py` & `algorin-cli-0.2/tests/test_file_extractor.py`

 * *Files identical despite different names*

### Comparing `algorin_cli-0.18/tests/test_main.py` & `algorin-cli-0.2/tests/test_main.py`
