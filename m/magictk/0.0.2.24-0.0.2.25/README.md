# Comparing `tmp/magictk-0.0.2.24.tar.gz` & `tmp/magictk-0.0.2.25.tar.gz`
...
## Comparing `magictk-0.0.2.24.tar` & `magictk-0.0.2.25.tar`
...
### Comparing `magictk-0.0.2.24/README.md` & `magictk-0.0.2.25/README.md`

 * *Files identical despite different names*

### Comparing `magictk-0.0.2.24/setup.py` & `magictk-0.0.2.25/setup.py`
