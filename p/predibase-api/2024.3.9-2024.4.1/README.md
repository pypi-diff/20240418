# Comparing `tmp/predibase-api-2024.3.9.tar.gz` & `tmp/predibase-api-2024.4.1.tar.gz`
...
## Comparing `predibase-api-2024.3.9.tar` & `predibase-api-2024.4.1.tar`
...
### Comparing `predibase-api-2024.3.9/predibase_api/artifacts/v1/artifacts_pb2.py` & `predibase-api-2024.4.1/predibase_api/artifacts/v1/artifacts_pb2.py`
...
### Comparing `predibase-api-2024.3.9/predibase_api/foobar/v1/bar_pb2.py` & `predibase-api-2024.4.1/predibase_api/foobar/v1/bar_pb2.py`
...
### Comparing `predibase-api-2024.3.9/predibase_api/foobar/v1/foo_pb2.py` & `predibase-api-2024.4.1/predibase_api/foobar/v1/foo_pb2.py`
...
### Comparing `predibase-api-2024.3.9/predibase_api/iterml/v1/iterml_pb2.py` & `predibase-api-2024.4.1/predibase_api/iterml/v1/iterml_pb2.py`
...
### Comparing `predibase-api-2024.3.9/predibase_api/profiles/v1/dataset_profile_pb2.py` & `predibase-api-2024.4.1/predibase_api/profiles/v1/dataset_profile_pb2.py`
...
### Comparing `predibase-api-2024.3.9/predibase_api/tenants/v1/tenants_pb2.py` & `predibase-api-2024.4.1/predibase_api/tenants/v1/tenants_pb2.py`
...
### Comparing `predibase-api-2024.3.9/predibase_api.egg-info/SOURCES.txt` & `predibase-api-2024.4.1/predibase_api.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `predibase-api-2024.3.9/setup.py` & `predibase-api-2024.4.1/setup.py`
