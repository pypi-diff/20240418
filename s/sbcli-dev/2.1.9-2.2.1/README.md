# Comparing `tmp/sbcli_dev-2.1.9.zip` & `tmp/sbcli_dev-2.2.1.zip`
...
## Comparing `sbcli_dev-2.1.9/simplyblock_web/caching_node_app_k8s.py` & `sbcli_dev-2.2.1/simplyblock_web/caching_node_app_k8s.py`
...
## Comparing `sbcli_dev-2.1.9/simplyblock_web/blueprints/web_api_cluster.py` & `sbcli_dev-2.2.1/simplyblock_web/blueprints/web_api_cluster.py`
...
## Comparing `sbcli_dev-2.1.9/simplyblock_core/cnode_client.py` & `sbcli_dev-2.2.1/simplyblock_core/cnode_client.py`
...
## Comparing `sbcli_dev-2.1.9/simplyblock_core/scripts/dashboards/cluster.json` & `sbcli_dev-2.2.1/simplyblock_core/scripts/dashboards/cluster.json`
...
## Comparing `sbcli_dev-2.1.9/simplyblock_core/services/log_agg_service.py` & `sbcli_dev-2.2.1/simplyblock_core/services/log_agg_service.py`
...
## Comparing `sbcli_dev-2.1.9/simplyblock_core/services/device_monitor.py` & `sbcli_dev-2.2.1/simplyblock_core/services/device_monitor.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/services/storage_node_monitor.py` & `sbcli_dev-2.2.1/simplyblock_core/services/storage_node_monitor.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/services/lvol_monitor.py` & `sbcli_dev-2.2.1/simplyblock_core/services/lvol_monitor.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/services/distr_event_collector.py` & `sbcli_dev-2.2.1/simplyblock_core/services/distr_event_collector.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/services/health_check_service.py` & `sbcli_dev-2.2.1/simplyblock_core/services/health_check_service.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/services/caching_node_monitor.py` & `sbcli_dev-2.2.1/simplyblock_core/services/caching_node_monitor.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/services/cap_monitor.py` & `sbcli_dev-2.2.1/simplyblock_core/services/cap_monitor.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/services/capacity_and_stats_collector.py` & `sbcli_dev-2.2.1/simplyblock_core/services/capacity_and_stats_collector.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/global_settings.py` & `sbcli_dev-2.2.1/simplyblock_core/models/global_settings.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/cluster.py` & `sbcli_dev-2.2.1/simplyblock_core/models/cluster.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/caching_node.py` & `sbcli_dev-2.2.1/simplyblock_core/models/caching_node.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/pool.py` & `sbcli_dev-2.2.1/simplyblock_core/models/pool.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/events.py` & `sbcli_dev-2.2.1/simplyblock_core/models/events.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/iface.py` & `sbcli_dev-2.2.1/simplyblock_core/models/iface.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/base_model.py` & `sbcli_dev-2.2.1/simplyblock_core/models/base_model.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/stats.py` & `sbcli_dev-2.2.1/simplyblock_core/models/stats.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/nvme_device.py` & `sbcli_dev-2.2.1/simplyblock_core/models/nvme_device.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/storage_node.py` & `sbcli_dev-2.2.1/simplyblock_core/models/storage_node.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/port_stat.py` & `sbcli_dev-2.2.1/simplyblock_core/models/port_stat.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/mgmt_node.py` & `sbcli_dev-2.2.1/simplyblock_core/models/mgmt_node.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/snapshot.py` & `sbcli_dev-2.2.1/simplyblock_core/models/snapshot.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/compute_node.py` & `sbcli_dev-2.2.1/simplyblock_core/models/compute_node.py`

 * *Files identical despite different names*

## Comparing `sbcli_dev-2.1.9/simplyblock_core/models/lvol_model.py` & `sbcli_dev-2.2.1/simplyblock_core/models/lvol_model.py`
