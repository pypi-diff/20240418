# Comparing `tmp/surfkit-0.1.83.tar.gz` & `tmp/surfkit-0.1.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "surfkit-0.1.83.tar", max compression
+gzip compressed data, was "surfkit-0.1.9.tar", max compression
```

## Comparing `surfkit-0.1.83.tar` & `surfkit-0.1.9.tar`

### file list

```diff
@@ -1,26 +1,13 @@
--rw-r--r--   0        0        0     1069 2024-04-09 16:39:37.152115 surfkit-0.1.83/LICENSE
--rw-r--r--   0        0        0      270 2024-04-03 02:13:16.594885 surfkit-0.1.83/README.md
--rw-r--r--   0        0        0      697 2024-04-18 04:10:23.458580 surfkit-0.1.83/pyproject.toml
--rw-r--r--   0        0        0     1726 2024-04-11 17:52:32.512640 surfkit-0.1.83/surfkit/agent.py
--rw-r--r--   0        0        0      602 2024-04-09 16:39:37.166082 surfkit-0.1.83/surfkit/cli/init.py
--rw-r--r--   0        0        0     6629 2024-04-17 22:08:07.372842 surfkit-0.1.83/surfkit/cli/main.py
--rw-r--r--   0        0        0    10733 2024-04-16 17:55:09.920080 surfkit-0.1.83/surfkit/cli/templates/agent.py
--rw-r--r--   0        0        0        0 2024-04-09 16:39:37.166494 surfkit-0.1.83/surfkit/cli/templates/device.py
--rw-r--r--   0        0        0     2053 2024-04-17 19:36:14.985684 surfkit-0.1.83/surfkit/config.py
--rw-r--r--   0        0        0     2007 2024-04-17 19:23:41.286231 surfkit-0.1.83/surfkit/db/conn.py
--rw-r--r--   0        0        0      982 2024-04-17 16:29:32.098357 surfkit-0.1.83/surfkit/db/models.py
--rw-r--r--   0        0        0      238 2024-04-17 19:35:04.174976 surfkit-0.1.83/surfkit/env.py
--rw-r--r--   0        0        0      993 2024-04-03 16:40:15.124046 surfkit-0.1.83/surfkit/hub.py
--rw-r--r--   0        0        0     7553 2024-04-17 00:47:37.183302 surfkit-0.1.83/surfkit/llm.py
--rw-r--r--   0        0        0     2413 2024-04-17 16:28:56.465927 surfkit-0.1.83/surfkit/models.py
--rw-r--r--   0        0        0     2987 2024-04-16 16:33:27.946404 surfkit-0.1.83/surfkit/runtime/agent/base.py
--rw-r--r--   0        0        0     7334 2024-04-17 16:35:57.476874 surfkit-0.1.83/surfkit/runtime/agent/docker.py
--rw-r--r--   0        0        0    26916 2024-04-17 16:35:43.879067 surfkit-0.1.83/surfkit/runtime/agent/kube.py
--rw-r--r--   0        0        0      910 2024-04-11 17:58:10.911174 surfkit-0.1.83/surfkit/runtime/agent/load.py
--rw-r--r--   0        0        0     1425 2024-04-11 22:52:18.482166 surfkit-0.1.83/surfkit/runtime/container/base.py
--rw-r--r--   0        0        0     5983 2024-04-16 16:34:59.842004 surfkit-0.1.83/surfkit/runtime/container/docker.py
--rw-r--r--   0        0        0    16077 2024-04-11 22:50:31.352813 surfkit-0.1.83/surfkit/runtime/container/kube.py
--rw-r--r--   0        0        0     1028 2024-04-11 16:49:49.850218 surfkit-0.1.83/surfkit/runtime/container/load.py
--rw-r--r--   0        0        0      402 2024-04-11 18:32:09.170609 surfkit-0.1.83/surfkit/runtime/vm/base.py
--rw-r--r--   0        0        0     9920 2024-04-17 20:04:44.519945 surfkit-0.1.83/surfkit/types.py
--rw-r--r--   0        0        0     1221 1970-01-01 00:00:00.000000 surfkit-0.1.83/PKG-INFO
...
### Comparing `surfkit-0.1.83/surfkit/db/conn.py` & `surfkit-0.1.9/surfkit/db/conn.py`
...
### Comparing `surfkit-0.1.83/surfkit/db/models.py` & `surfkit-0.1.9/surfkit/db/models.py`
...
### Comparing `surfkit-0.1.83/surfkit/hub.py` & `surfkit-0.1.9/surfkit/hub.py`

 * *Files identical despite different names*

### Comparing `surfkit-0.1.83/surfkit/models.py` & `surfkit-0.1.9/surfkit/models.py`
...
### Comparing `surfkit-0.1.83/surfkit/types.py` & `surfkit-0.1.9/surfkit/types.py`
